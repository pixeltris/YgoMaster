...
- In the client console run `carddata` which should create `/Data/ClientDataDump/Card/Data/{Current_Version}`, move and rename the `{Current_Version}` folder to `/Data/CardData/`.
